            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="pegawai-kontrak.php"><i data-feather="layout"></i><span>Pegawai Kontrak</span></a>
                  </li>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Tambah Pegawai Kontrak</b></h3></center>
                    <form class="form theme-form" action="proses-tambah-pegawai-kontrak.php" method="post">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                   ...
                                   <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                      <label class="col-sm-3 col-form-label">Lulusan</label>
                                      <div class="col-sm-9">
                                        <select class="form-select digits" id="id" name="id_lulusan">
