            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="golongan.php"><i data-feather="layout"></i><span>Golongan</span></a>
                  </li>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="card-body">
                  ...
                  <br>
                  <br>
                    <center><h3><b>Edit Golongan dan Masa Kerja Golongan</b></h3></center>
                    ...
                    <?php
                      ...
                      echo '<form class="form theme-form" action="proses-edit-golongan.php?id='.$id_golongan.'" method="post">';


                      $sql = "SELECT * FROM `tb_gaji` WHERE `id_gaji`=".$id_golongan;
                      ...
                      while ($row1 = mysqli_fetch_array($query)){
                        ...
                        $id_golongan_old = $row1['id_golongan'];

                        echo '<div class="mb-3 row">
                                      <label class="col-sm-3 col-form-label">Golongan</label>
                                      <div class="col-sm-9">
                                      <select class="form-select digits" id="id" name="gol">';
                        ...
                        echo'
                            ...
                            <div class="mb-3 row">
                              ...
                              <div class="col-sm-9">
                                <input class="form-control" type="number" name="gaji" required="required" value="'.$row1['gaji'].'">
                              </div>
                            </div>
                        ';
                        ...
                        echo'
                            ...
                            <div class="mb-3 row">
                              <label class="col-sm-3 col-form-label">MKG</label>
                              <div class="col-sm-9">
                                <input class="form-control" type="number" name="masa_kerja" required="required" value="'.$row1['masa_kerja'].'">
                              </div>
                            </div>
                        ';
