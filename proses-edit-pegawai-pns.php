<?php
    ...
    $query="UPDATE `tb_pegawai_pns` SET `nip`='$nip',`nama`='$nama_pegawai',`hp`='$hp',`id_golongan`='$golongan',`id_eselon`='$eselon',`tunjangan_istri`='$tunjangan_istri',`tunjangan_anak`='$tunjangan_anak',`tunjangan_beras`='$tunjangan_beras',`tunjangan_pajak`='$pajak',`bpjs`='$tunjangan_bpjs',`tunjangan_fungsional`='$nominal_tunjangan_fungsional',`taperum`='$nominal_taperum',`tunjangan_jkk`='$tunjangan_jkk',`tunjangan_jkm`='$tunjangan_jkm',`tunjangan_iwp`='$tunjangan_iwp',`status`='$status_txt',`jumlah_anak`='$jumlah_anak',`masa_kerja`='$masa_kerja',`gaji_pokok`='$gaji_pokok',`gaji_kotor`='$gaji_kotor',`potongan`='$potongan',`gaji_bersih`='$gaji_bersih' WHERE `id_pegawai_pns`=".$id_pegawai; 
