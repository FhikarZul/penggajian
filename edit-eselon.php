            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Edit Eselon</b></h3></center>
                    ...
                    <?php
                      ...
                      echo '<form class="form theme-form" action="proses-edit-eselon.php?id='.$id_eselon.'" method="post">';


                      $sql = "SELECT * FROM `tb_eselon` WHERE `id_eselon`=".$id_eselon;
                      ...
                      while ($row = mysqli_fetch_array($query)){
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 row">
                              ...
                              <div class="col-sm-9">
                                <input class="form-control" type="text" name="gol" required="required" value="'.$row['golongan'].'">
                              </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                              ...
                              <div class="col-sm-9">
                                <input class="form-control" type="number" name="nominal" required="required" value="'.$row['nominal'].'">
                              </div>
                            </div>
                        ';
