          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                ...
                <a class="btn btn-primary" href="tambah-pegawai-pns.php">Tambah Pegawai</a>
                </br></br>        
                <div class="card">
                ...
                <div class="table-responsive" style="
                    ...
                    <table class="table">
                      ...
                      <?php
                        ...
                        $sql1 = "SELECT `id_pegawai_pns`, `nip`, `nama`, `hp`, tb_golongan.golongan, `tb_eselon`.`golongan` AS 'eselon', `tunjangan_istri`, `tunjangan_anak`, `tunjangan_pajak`, `bpjs`, `status`, `jumlah_anak`, `masa_kerja`, `gaji_pokok`, `gaji_kotor`, `gaji_bersih` FROM `tb_pegawai_pns`, `tb_golongan`, `tb_eselon` WHERE tb_golongan.id_golongan = tb_pegawai_pns.id_golongan AND tb_eselon.id_eselon = tb_pegawai_pns.id_eselon";
                        ...
                        while ($row = mysqli_fetch_array($query1)){
                          ...
                          echo'
                            <tr>
                                ...
                                <td>
                                  <center>
                                    <a class="btn btn-danger" href="proses-hapus-pegawai-pns.php?id='.$row['id_pegawai_pns'].'">Hapus</a>
                                    <a class="btn btn-success" href="edit-pegawai-pns.php?id='.$row['id_pegawai_pns'].'">Edit</a>
                                    <a  href="cetak-slip-gaji-pns.php?id='.$row['id_pegawai_pns'].'"><i data-feather="printer"></i></a>
                                  </center>
                                </td>
                            </tr>
                          ';
                    ...
                    <div class="card-footer text-end">
                      <?php
                        if(!$status){
                          echo '
                                  <a class="btn btn-primary" href="kirim-sms-gateway.php?id=1">SMS Gateway</a>

                                  <a class="btn btn-primary" href="cetak-rekap-gaji.php">Rekap Gaji</a>
