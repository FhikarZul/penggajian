            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="eselon.php"><i data-feather="layout"></i><span>Eselon</span></a>
                  </li>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                ...
                <a class="btn btn-primary" href="tambah-golongan.php">Tambah Golongan dan Masa Kerja</a>
                </br></br>        
                <div class="card">
                ...
                <div class="table-responsive" style="
                    ...
                    <table class="table">
                      ...
                      <?php
                        ...
                        $sql1 = "SELECT `id_gaji`, `gaji`, `masa_kerja`, `tb_golongan`.`golongan` FROM `tb_gaji`, `tb_golongan` WHERE `tb_golongan`.`id_golongan`=`tb_gaji`.`id_golongan`";
                        ...
                        while ($row = mysqli_fetch_array($query1)){
                          ...
                          echo'
                            <tr>
                                ...
                                <td>'.$row['golongan'].'</td>
                                <td>'.$row['gaji'].'</td>
                                <td>'.$row['masa_kerja'].' tahun</td>

                                <td>
                                  <center>
                                    <a class="btn btn-danger" href="proses-hapus-golongan.php?id='.$row['id_gaji'].'">Hapus</a>
                                    <a class="btn btn-success" href="edit-golongan.php?id='.$row['id_gaji'].'">Edit</a>
                                  </center>
                                </td>
                            </tr>
                          ';
