            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="absensi-pegawai-pns.php"><i data-feather="layout"></i><span>Absensi Pegawai PNS</span></a>
                  </li>
                  <li class="dropdown"><a class="nav-link" href="absensi-pegawai-kontrak.php"><i data-feather="layout"></i><span>Absensi Pegawai Kontrak</span></a>
                  </li>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Tambah Data Absensi</b></h3></center>
                    <form class="form theme-form" action="proses-tambah-data-absensi-kontrak.php" method="post">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                      <select class="form-select digits" id="id" name="id_pegawai">
                                      <?php
                                            include 'config/koneksi.php';

                                            $sql1 = "SELECT * FROM `tb_pegawai_kontrak`";
                                            $query1 = mysqli_query($connect, $sql1);

                                            while ($row = mysqli_fetch_array($query1)){
                                              echo '<option value="'.$row['id_pegawai_kontrak'].'">'.$row['nama_pegawai'].'</option>';
                                            }
                                      ?>
                                      </select>
                                      </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="date" name="tgl" required="required">
                                      </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <select class="form-select digits" id="id" name="id_kehadiran">
