            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link" href="absensi-pns.php"><i data-feather="layout"></i><span>Absensi Pegawai PNS</span></a>
                  </li>
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <br>
                    ...
                    <form class="form theme-form" action="proses-tambah-data-absensi-pns.php" method="post">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col">
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <?php
                                            ...
                                            while ($row = mysqli_fetch_array($query1)){
                                              echo '<option value="'.$row['id_pegawai_pns'].'">'.$row['nama'].'</option>';
                                            }
                                      ?>
                                      </select>
                                      </div>
