                ...
                <div class="table-responsive" style="
                        ...
                        while ($row = mysqli_fetch_array($query1)){
                          ...
                          echo'
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-danger" href="proses-hapus-pegawai-kontrak.php?id='.$row['id_pegawai_kontrak'].'">Hapus</a>
                                <a  href="cetak-slip-gaji-kontrak.php?id='.$row['id_pegawai_kontrak'].'"><i data-feather="printer"></i></a>
                                </td>
                            </tr>
                          ';
                          $i++;
                    ...
                    <div class="card-footer text-end">
                      <?php
                        if(!$status){
                          echo '
                          <a class="btn btn-primary" href="kirim-sms-gateway.php?id=2">SMS Gateway</a>
                              ';
                        }
                      ?>
