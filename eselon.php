          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php 
                ...
                <a class="btn btn-primary" href="tambah-eselon.php">Tambah Eselon</a>
                </br></br>        
                <div class="card">
                        ...
                        while ($row = mysqli_fetch_array($query1)){
                          ...
                          echo'
                            <tr>
                                ...
                                <td>
                                  <center>
                                    <a class="btn btn-danger" href="proses-hapus-eselon.php?id='.$row['id_eselon'].'">Hapus</a>
                                    <a class="btn btn-success" href="edit-eselon.php?id='.$row['id_eselon'].'">Edit</a>
                                  </center>
                                </td>
                            </tr>
                          ';
