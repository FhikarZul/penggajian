            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <br>
                  <br>
                    <center><h3><b>Tambah Eselon</b></h3></center>
                    <form class="form theme-form" action="proses-tambah-eselon.php" method="post">
                                  ...
                                  <div class="card-body">
                                   ...
                                   <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="gol" required="required">
                                      </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="text" name="ket" required="required">
                                      </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-9">
                                        <input class="form-control" type="number" name="nominal" required="required">
                                      </div>
                                    </div>
